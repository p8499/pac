 ...
 */
public class DropViewGenerator extends Generator1 {
    public DropViewGenerator(Map project) {
        super(project);
    ...
    public String getContent(int index) throws Exception {
        ...
        Template template = getVelocityEngine().getTemplate("com/p8499/paca/templates/database/module/drop_view.vm");
