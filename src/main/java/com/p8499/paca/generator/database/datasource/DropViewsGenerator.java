 ...
 */
public class DropViewsGenerator extends Generator1 {
    public DropViewsGenerator(Map project) {
        super(project);
    ...
    public File getPath(File folder, int index) throws Exception {
        ...
        return new File(folder, String.format("%s_drop_views.sql", datasource.get("id")));
    }
    ...
    public String getContent(int index) throws Exception {
        ...
        Template template = getVelocityEngine().getTemplate("com/p8499/paca/templates/database/datasource/drop_views.vm");
