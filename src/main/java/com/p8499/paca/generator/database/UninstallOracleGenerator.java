 ...
 */
public class UninstallOracleGenerator extends Generator0 {
    public UninstallOracleGenerator(Map project) {
        super(project);
    ...
    public File getPath(File folder) {
        return new File(folder, "uninstall_oracle.sql");
    }

    @Override
    public String getContent() throws IOException {
        Template template = getVelocityEngine().getTemplate("com/p8499/paca/templates/database/uninstall_oracle.vm");
