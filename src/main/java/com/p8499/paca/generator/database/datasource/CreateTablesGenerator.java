 ...
 */
public class CreateTablesGenerator extends Generator1 {
    public CreateTablesGenerator(Map project) {
        super(project);
    ...
    public File getPath(File folder, int index) throws Exception {
        ...
        return new File(folder, String.format("%s_create_tables.sql", datasource.get("id")));
    }
    ...
    public String getContent(int index) throws Exception {
        ...
        Template template = getVelocityEngine().getTemplate("com/p8499/paca/templates/database/datasource/create_tables.vm");
