 ...
 */
public class CreateViewGenerator extends Generator1 {
    public CreateViewGenerator(Map project) {
        super(project);
    ...
    public File getPath(File folder, int index) throws Exception {
        ...
        return new File(folder, String.format("%s_create_view_%s.sql", module.get("datasource"), module.get("id")));
    }
    ...
    public String getContent(int index) throws Exception {
        ...
        Template template = getVelocityEngine().getTemplate("com/p8499/paca/templates/database/module/create_view.vm");
