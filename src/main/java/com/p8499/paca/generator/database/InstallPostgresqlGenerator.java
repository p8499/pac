 ...
 */
public class InstallPostgresqlGenerator extends Generator0 {
    public InstallPostgresqlGenerator(Map project) {
        super(project);
    ...
    public File getPath(File folder) {
        return new File(folder, "install_postgresql.sql");
    }

    @Override
    public String getContent() throws IOException {
        Template template = getVelocityEngine().getTemplate("com/p8499/paca/templates/database/install_postgresql.vm");
