 ...
 */
public class DropAllGenerator extends Generator1 {
    public DropAllGenerator(Map project) {
        super(project);
    ...
    public File getPath(File folder, int index) throws Exception {
        ...
        return new File(folder, String.format("%s_drop_all.sql", datasource.get("id")));
    }
    ...
    public String getContent(int index) throws Exception {
        ...
        Template template = getVelocityEngine().getTemplate("com/p8499/paca/templates/database/datasource/drop_all.vm");
