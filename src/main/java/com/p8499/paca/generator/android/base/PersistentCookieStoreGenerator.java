 ...
 */
public class PersistentCookieStoreGenerator extends Generator0 {
    public PersistentCookieStoreGenerator(Map project) {
        super(project);
    ...
    public File getPath(File folder) {
        ...
        return new File(folder, "src/main/java/" + packageName.replace(".", "/") + "/" + "PersistentCookieStore.java");
    }

    @Override
    public String getContent() throws IOException {
        Template template = getVelocityEngine().getTemplate("com/p8499/paca/templates/android/base/PersistentCookieStore.vm");
