 ...
 */
public class StubGenerator extends Generator1 {
    public StubGenerator(Map project) {
        super(project);
    ...
    public File getPath(File folder, int index) {
        ...
        String packageName = (String) ((Map) project.get("envAndroid")).get("packageStub");
        String className = (String) ((Map) ((List) project.get("modules")).get(index)).get("androidStubAlias");
    ...
    public String getContent(int index) throws IOException, FormatterException {
        ...
        Template template = getVelocityEngine().getTemplate("com/p8499/paca/templates/android/module/stub.vm");
