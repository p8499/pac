 ...
 */
public class MaskGenerator extends Generator1 {
    public MaskGenerator(Map project) {
        super(project);
    ...
    public File getPath(File folder, int index) {
        ...
        String packageName = (String) ((Map) project.get("envAndroid")).get("packageMask");
        String className = (String) ((Map) ((List) project.get("modules")).get(index)).get("androidMaskAlias");
    ...
    public String getContent(int index) throws IOException, FormatterException {
        ...
        Template template = getVelocityEngine().getTemplate("com/p8499/paca/templates/android/module/mask.vm");
