 ...
 */
public class BeanGenerator extends Generator1 {
    public BeanGenerator(Map project) {
        super(project);
    ...
    public File getPath(File folder, int index) {
        ...
        String packageName = (String) ((Map) project.get("envAndroid")).get("packageBean");
        String className = (String) ((Map) ((List) project.get("modules")).get(index)).get("androidBeanAlias");
    ...
    public String getContent(int index) throws IOException, FormatterException {
        ...
        Template template = getVelocityEngine().getTemplate("com/p8499/paca/templates/android/module/bean.vm");
