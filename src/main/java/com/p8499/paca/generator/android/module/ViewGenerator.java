 ...
 */
public class ViewGenerator extends Generator1 {
    public ViewGenerator(Map project) {
        super(project);
    ...
    public File getPath(File folder, int index) {
        ...
        String className = (String) ((Map) ((List) project.get("modules")).get(index)).get("androidViewAlias");
    ...
    public String getContent(int index) throws IOException, FormatterException {
        ...
        Template template = getVelocityEngine().getTemplate("com/p8499/paca/templates/android/module/view.vm");
