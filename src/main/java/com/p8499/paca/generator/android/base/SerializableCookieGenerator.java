 ...
 */
public class SerializableCookieGenerator extends Generator0 {
    public SerializableCookieGenerator(Map project) {
        super(project);
    ...
    public File getPath(File folder) {
        ...
        return new File(folder, "src/main/java/" + packageName.replace(".", "/") + "/" + "SerializableCookie.java");
    }

    @Override
    public String getContent() throws IOException {
        Template template = getVelocityEngine().getTemplate("com/p8499/paca/templates/android/base/SerializableCookie.vm");
