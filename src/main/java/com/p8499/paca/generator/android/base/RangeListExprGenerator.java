 ...
 */
public class RangeListExprGenerator extends Generator0 {
    public RangeListExprGenerator(Map project) {
        super(project);
    ...
    public File getPath(File folder) {
        ...
        return new File(folder, "src/main/java/" + packageName.replace(".", "/") + "/" + "RangeListExpr.java");
    }

    @Override
    public String getContent() throws IOException {
        Template template = getVelocityEngine().getTemplate("com/p8499/paca/templates/android/base/RangeListExpr.vm");
