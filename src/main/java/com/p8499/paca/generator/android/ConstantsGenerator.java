 ...
 */
public class ConstantsGenerator extends Generator0 {
    public ConstantsGenerator(Map project) {
        super(project);
    ...
    public File getPath(File folder) {
        return new File(folder, "src/main/res/values/constants.xml");
    }

    @Override
    public String getContent() throws IOException {
        Template template = getVelocityEngine().getTemplate("com/p8499/paca/templates/android/constants.vm");
