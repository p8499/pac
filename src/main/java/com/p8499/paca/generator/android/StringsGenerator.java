 ...
 */
public class StringsGenerator extends Generator0 {
    public StringsGenerator(Map project) {
        super(project);
    ...
    public File getPath(File folder) {
        return new File(folder, "src/main/res/values/strings.xml");
    }

    @Override
    public String getContent() throws IOException {
        Template template = getVelocityEngine().getTemplate("com/p8499/paca/templates/android/strings.vm");
