package com.p8499.paca.generator.android.module;
 ...
 */
public class ListViewGenerator extends Generator1 {
    public ListViewGenerator(Map project) {
        super(project);
    ...
    public File getPath(File folder, int index) {
        ...
        String packageName = (String) ((Map) project.get("envAndroid")).get("packageView");
        String className = (String) ((Map) ((List) project.get("modules")).get(index)).get("androidListViewAlias");
    ...
    public String getContent(int index) throws IOException, FormatterException {
        ...
        Template template = getVelocityEngine().getTemplate("com/p8499/paca/templates/android/module/listView.vm");
